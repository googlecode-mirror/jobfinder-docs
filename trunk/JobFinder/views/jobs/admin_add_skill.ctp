...
<?php echo $this->element('admin_sidebar'); ?>
	...
	<div id="box">
        ...
        <?php echo $this->Form->input('JobSkill.job_id', array('type'=>'hidden','div'=>false,'value' => $this->Session->read('jobID'),'error'=>array('wrap'=>'span'))); ?>
		...
		<?php echo $ajax->observeField('skillGroups',array('url'=>'getSkills','update'=>'skills','admin'=>false));?>
		<div align="center">
			<br/>
    ...
    <tr>
		...
		<td><?php echo $this->Html->link(__('Sửa', true), array('action' => 'admin_editSkill', $jobSkill['JobSkill']['id'])); ?>
			<?php echo $this->Html->link(__('Xóa', true), array('action' => 'admin_deleteSkill', $jobSkill['JobSkill']['id']), null, sprintf(__('Bạn có chắc muốn xóa kỹ năng %s?', true), $listSkills[$jobSkill['JobSkill']['skill_id']])); ?>
		</td>
	</tr>
    <?php endforeach; ?>
	</table>
