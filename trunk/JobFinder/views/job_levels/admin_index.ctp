<div class="job_levels index">
	<h2><?php __('Job Levels');?></h2>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $jobLevel['JobLevel']['id']; ?>&nbsp;</td>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('New Job Level', true), array('action' => 'add')); ?></li>
