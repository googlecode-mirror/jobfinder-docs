...
<?php
	...
	<tr<?php echo $class;?>>
		...
		<td class="a-center">
			<?php echo $this->Html->link(__('Sửa', true), array('action' => 'edit', $country['Country']['id'])); ?> | 
			<?php echo $this->Html->link(__('Xóa', true), array('action' => 'delete', $country['Country']['id']), null, sprintf(__('Bạn có chắc muốn xóa %s ?', true), $country['Country']['name'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
	...
	<?php
		...
		echo $this->Form->input('name',array('label'=>'Tên quốc gia:','div'=>false,'error'=>array('wrap'=>'span')));
	?>
		<div align="center">
        <br />
