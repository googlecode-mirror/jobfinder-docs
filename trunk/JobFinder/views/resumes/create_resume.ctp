    ...
    <?php echo $this->Form->create('Resume',array('action'=>'createResume'));?>
        ...
        <div id="right_cr">
                            ...
                            <tr>
                                ...
                                <td width="82%">
                                    <?php echo $this->Form->radio('privacy_status',
                                            ...
                                            array('legend'=>false,'default'=>1,'error'=>array('wrap'=>'span'))); ?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <div class="form_field">
                                ...
                                <p>
                                    ...
                                    <?php echo $this->Form->input('last_name', array('label'=>false,
                                            'class'=>'field field_dis','div'=>false,
                                            'value'=> $jobseeker['Jobseeker']['last_name'], 'disabled'=> true,'error'=>array('wrap'=>'span')));?>
                                </p>
            ...
            <div style="text-align: right;">
                <?php echo $this->Html->link($html->tag('span', 'Hủy'), 
