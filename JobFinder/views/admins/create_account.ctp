...
<br/>
	<div id="box">
        ...
        <?php echo $this->Form->input('username',array('label'=>'Tên đăng nhập:','div'=>false,'error'=>array('wrap'=>'span'))); ?>
        <?php echo $this->Form->input('password',array('label'=>'Mật khẩu:','div'=>false,'error'=>array('wrap'=>'span'))); ?>
        <?php echo $this->Form->input('confirm_password',array('label'=>'Xác nhận mật khẩu:','type'=>'password','div'=>false,'error'=>array('wrap'=>'span'))); ?>
		<div align="center">
			<br/>
	    	<?php echo $this->Form->Submit(__('Tạo tài khoản', true),array('div'=>false));?>
