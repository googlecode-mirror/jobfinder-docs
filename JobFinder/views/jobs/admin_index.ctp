...
<?php echo $this->element('admin_sidebar'); ?>
    ...
    <tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Xem', true), array('action' => 'view', $job['Job']['id'], 'admin'=> true)); ?>
			<?php echo $this->Html->link(__('Cập nhật', true), array('action' => 'preview', $job['Job']['id'], 'admin'=> true)); ?>
