...
<div id="wrapper">
	...
	<div class="paging">
		...
		<br/>
	<div id="box">
		<h3>Thông tin Kỹ năng</h3>
		<?php echo $this->Session->flash(); ?>
		<?php echo $this->Form->create('Skill',array('div'=>false,'id'=>'form'));?>
		<?php echo $this->Form->Input('skill_group_id',array('label'=>'Nhóm kỹ năng:','div'=>false,'empty'=>'Vui lòng chọn...','class'=>'block','error'=>array('wrap'=>'span'),'disabled'=>true));?>
		<?php echo $this->Form->Input('name',array('label'=>'Tên kỹ năng:','div'=>false,'error'=>array('wrap'=>'span'),'disabled'=>true));?>
		<div align="center">
			<br/>
	    	<?php echo $this->Html->link(__('Thêm mới', true),array('action' => 'index'));?> | 
	    	<?php echo $this->Html->link(__('Chỉnh sửa', true), array('action' => 'edit', $this->data['Skill']['id'])); ?>
	    </div>
	</div>
	</div>
</div>
